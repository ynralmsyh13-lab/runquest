...
def render_sidebar(profile, page, c):
    with st.sidebar:
        ...
        # Logo - bracket frame, full width text
        logo_bg = "#0A0C12" if c["dark_mode"] else "#FFF8EC"

        st.markdown(f"""
        <div style='padding:16px 12px 14px; background:{logo_bg}; border-bottom:2px solid {c["ACCENT"]}; position:relative; overflow:hidden;'>
            ...
            <div style='border:1px solid {c["ACCENT"]}40; padding:10px 10px; position:relative; border-radius:2px;'>
                <div style='position:absolute; top:-1px; left:10px; right:10px; height:2px; background:{c["ACCENT"]};'></div>
                <div style='position:absolute; bottom:-1px; left:10px; right:10px; height:1px; background:{c["ACCENT"]}60;'></div>
                ...
                <div style='font-family:Share Tech Mono,monospace; font-size:0.48rem; color:{c["ACCENT"]}80; letter-spacing:3px; margin-bottom:6px;'>[ SYS:ACTIVE ]</div>
                <div style='font-family:Orbitron,sans-serif; font-weight:900; letter-spacing:1px; line-height:1; margin-bottom:6px; font-size:1.35rem; white-space:nowrap; overflow:hidden;'>
                    <span style='color:{c["ACCENT"]};'>RUN</span><span style='color:{c["TEXT"]};'>QUEST</span>
                </div>
                <div style='font-family:Share Tech Mono,monospace; font-size:0.45rem; color:{c["TEXT3"]}; letter-spacing:3px;'>v2.0 // PERF TRACK</div>
            </div>
        </div>
        """, unsafe_allow_html=True)

        # Rank block with SVG icon
        RANK_SVGS_SIDEBAR = [
            f'<svg width="28" height="28" viewBox="0 0 26 26" fill="none"><circle cx="13" cy="13" r="10" stroke="{c["ACCENT"]}" stroke-width="1.5" fill="rgba(255,179,0,0.15)"/><circle cx="13" cy="13" r="4" fill="{c["ACCENT"]}"/></svg>',
            f'<svg width="28" height="28" viewBox="0 0 26 26" fill="none"><polygon points="13,2 24,22 2,22" stroke="{c["ACCENT"]}" stroke-width="1.5" fill="rgba(255,179,0,0.15)"/><polygon points="13,9 18,19 8,19" fill="{c["ACCENT"]}"/></svg>',
            f'<svg width="28" height="28" viewBox="0 0 26 26" fill="none"><rect x="5" y="5" width="16" height="16" stroke="{c["ACCENT"]}" stroke-width="1.5" fill="rgba(255,179,0,0.15)" transform="rotate(45 13 13)"/><rect x="9" y="9" width="8" height="8" fill="{c["ACCENT"]}" transform="rotate(45 13 13)"/></svg>',
            f'<svg width="28" height="28" viewBox="0 0 26 26" fill="none"><polygon points="13,2 20,7 23,15 18,23 8,23 3,15 6,7" stroke="{c["ACCENT"]}" stroke-width="1.5" fill="rgba(255,179,0,0.15)"/><circle cx="13" cy="13" r="3" fill="{c["ACCENT"]}"/></svg>',
            f'<svg width="28" height="28" viewBox="0 0 26 26" fill="none"><polygon points="13,1 15.5,9.5 24,9.5 17.5,14.5 20,23 13,18 6,23 8.5,14.5 2,9.5 10.5,9.5" stroke="{c["ACCENT"]}" stroke-width="1.5" fill="rgba(255,179,0,0.15)"/></svg>',
            f'<svg width="28" height="28" viewBox="0 0 26 26" fill="none"><path d="M13 2 L22 6 L22 16 L13 24 L4 16 L4 6 Z" stroke="{c["ACCENT"]}" stroke-width="1.5" fill="rgba(255,179,0,0.15)"/><path d="M13 7 L18 10 L18 15 L13 20 L8 15 L8 10 Z" fill="{c["ACCENT"]}"/></svg>',
            f'<svg width="28" height="28" viewBox="0 0 26 26" fill="none"><circle cx="13" cy="13" r="11" stroke="{c["ACCENT"]}" stroke-width="1.5" fill="none"/><circle cx="13" cy="13" r="7" stroke="{c["ACCENT"]}" stroke-width="1" fill="rgba(255,179,0,0.12)"/><circle cx="13" cy="13" r="3" fill="{c["ACCENT"]}"/></svg>',
            f'<svg width="28" height="28" viewBox="0 0 26 26" fill="none"><path d="M13 2 L24 9 L20 22 L6 22 L2 9 Z" stroke="{c["ACCENT"]}" stroke-width="1.5" fill="rgba(255,179,0,0.15)"/><path d="M13 7 L18 11 L16 18 L10 18 L8 11 Z" fill="{c["ACCENT"]}"/></svg>',
            f'<svg width="28" height="28" viewBox="0 0 26 26" fill="none"><polygon points="13,1 14.8,8.5 22,7 16.5,12 22,17 14.8,15.5 13,23 11.2,15.5 4,17 9.5,12 4,7 11.2,8.5" stroke="{c["ACCENT"]}" stroke-width="1.2" fill="rgba(255,179,0,0.15)"/><circle cx="13" cy="12" r="3" fill="{c["ACCENT"]}"/></svg>',
            f'<svg width="28" height="28" viewBox="0 0 26 26" fill="none"><circle cx="13" cy="13" r="9" stroke="{c["ACCENT"]}" stroke-width="1.5" fill="rgba(255,179,0,0.12)"/><circle cx="13" cy="13" r="4" fill="{c["ACCENT"]}"/><line x1="13" y1="1" x2="13" y2="4" stroke="{c["ACCENT"]}" stroke-width="1.5"/><line x1="13" y1="22" x2="13" y2="25" stroke="{c["ACCENT"]}" stroke-width="1.5"/><line x1="1" y1="13" x2="4" y2="13" stroke="{c["ACCENT"]}" stroke-width="1.5"/><line x1="22" y1="13" x2="25" y2="13" stroke="{c["ACCENT"]}" stroke-width="1.5"/></svg>',
        ]
        rank_svg = RANK_SVGS_SIDEBAR[min(rank["level"]-1, 9)]
...
def page_dashboard(user_id, profile, runs, unit, c):
    ...
    ac = c["ACCENT"]
    RANK_SVGS_DASH = [
        f'<svg width="52" height="52" viewBox="0 0 26 26" fill="none"><circle cx="13" cy="13" r="10" stroke="{ac}" stroke-width="1.5" fill="rgba(255,179,0,0.15)"/><circle cx="13" cy="13" r="4" fill="{ac}"/></svg>',
        f'<svg width="52" height="52" viewBox="0 0 26 26" fill="none"><polygon points="13,2 24,22 2,22" stroke="{ac}" stroke-width="1.5" fill="rgba(255,179,0,0.15)"/><polygon points="13,9 18,19 8,19" fill="{ac}"/></svg>',
        f'<svg width="52" height="52" viewBox="0 0 26 26" fill="none"><rect x="5" y="5" width="16" height="16" stroke="{ac}" stroke-width="1.5" fill="rgba(255,179,0,0.15)" transform="rotate(45 13 13)"/><rect x="9" y="9" width="8" height="8" fill="{ac}" transform="rotate(45 13 13)"/></svg>',
        f'<svg width="52" height="52" viewBox="0 0 26 26" fill="none"><polygon points="13,2 20,7 23,15 18,23 8,23 3,15 6,7" stroke="{ac}" stroke-width="1.5" fill="rgba(255,179,0,0.15)"/><circle cx="13" cy="13" r="3" fill="{ac}"/></svg>',
        f'<svg width="52" height="52" viewBox="0 0 26 26" fill="none"><polygon points="13,1 15.5,9.5 24,9.5 17.5,14.5 20,23 13,18 6,23 8.5,14.5 2,9.5 10.5,9.5" stroke="{ac}" stroke-width="1.5" fill="rgba(255,179,0,0.15)"/></svg>',
        f'<svg width="52" height="52" viewBox="0 0 26 26" fill="none"><path d="M13 2 L22 6 L22 16 L13 24 L4 16 L4 6 Z" stroke="{ac}" stroke-width="1.5" fill="rgba(255,179,0,0.15)"/><path d="M13 7 L18 10 L18 15 L13 20 L8 15 L8 10 Z" fill="{ac}"/></svg>',
        f'<svg width="52" height="52" viewBox="0 0 26 26" fill="none"><circle cx="13" cy="13" r="11" stroke="{ac}" stroke-width="1.5" fill="none"/><circle cx="13" cy="13" r="7" stroke="{ac}" stroke-width="1" fill="rgba(255,179,0,0.12)"/><circle cx="13" cy="13" r="3" fill="{ac}"/></svg>',
        f'<svg width="52" height="52" viewBox="0 0 26 26" fill="none"><path d="M13 2 L24 9 L20 22 L6 22 L2 9 Z" stroke="{ac}" stroke-width="1.5" fill="rgba(255,179,0,0.15)"/><path d="M13 7 L18 11 L16 18 L10 18 L8 11 Z" fill="{ac}"/></svg>',
        f'<svg width="52" height="52" viewBox="0 0 26 26" fill="none"><polygon points="13,1 14.8,8.5 22,7 16.5,12 22,17 14.8,15.5 13,23 11.2,15.5 4,17 9.5,12 4,7 11.2,8.5" stroke="{ac}" stroke-width="1.2" fill="rgba(255,179,0,0.15)"/><circle cx="13" cy="12" r="3" fill="{ac}"/></svg>',
        f'<svg width="52" height="52" viewBox="0 0 26 26" fill="none"><circle cx="13" cy="13" r="9" stroke="{ac}" stroke-width="1.5" fill="rgba(255,179,0,0.12)"/><circle cx="13" cy="13" r="4" fill="{ac}"/><line x1="13" y1="1" x2="13" y2="4" stroke="{ac}" stroke-width="1.5"/><line x1="13" y1="22" x2="13" y2="25" stroke="{ac}" stroke-width="1.5"/><line x1="1" y1="13" x2="4" y2="13" stroke="{ac}" stroke-width="1.5"/><line x1="22" y1="13" x2="25" y2="13" stroke="{ac}" stroke-width="1.5"/></svg>',
    ]
    dash_rank_svg = RANK_SVGS_DASH[min(rank["level"]-1, 9)]

    st.markdown(f"""
    <div class='cyber-card'>
      <div style='display:flex; align-items:center; gap:14px; flex-wrap:wrap;'>
        <div style='font-size:2.8rem; line-height:1;'>{dash_rank_svg}</div>
