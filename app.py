...
def render_sidebar(profile, page, c):
    with st.sidebar:
        ...
        logo_border_outer = c["BORDER2"]
        logo_inner_border = c["ACCENT"] + "40"
        ...
        <div style='padding:20px 16px 16px;
            ...
            <!-- bracket frame -->
            <div style='border:1px solid {logo_inner_border};
                padding:12px 14px; position:relative; border-radius:2px; margin-bottom:0;'>

                <!-- top scanline bar -->
                <div style='position:absolute; top:-1px; left:12px; right:12px;
                    height:2px; background:{c["ACCENT"]};'></div>
                <!-- bottom scanline bar -->
                <div style='position:absolute; bottom:-1px; left:12px; right:12px;
                    height:1px; background:{c["ACCENT"]}60;'></div>
                <!-- corner cuts top-left -->
                <div style='position:absolute; top:-3px; left:-3px; width:8px; height:8px;
                    border-top:2px solid {c["ACCENT"]}; border-left:2px solid {c["ACCENT"]};
                    background:{logo_bg};'></div>
                <!-- corner cuts top-right -->
                <div style='position:absolute; top:-3px; right:-3px; width:8px; height:8px;
                    border-top:2px solid {c["ACCENT"]}; border-right:2px solid {c["ACCENT"]};
                    background:{logo_bg};'></div>
                <!-- corner cuts bottom-left -->
                <div style='position:absolute; bottom:-3px; left:-3px; width:8px; height:8px;
                    border-bottom:2px solid {c["ACCENT"]}60; border-left:2px solid {c["ACCENT"]}60;
                    background:{logo_bg};'></div>
                <!-- corner cuts bottom-right -->
                <div style='position:absolute; bottom:-3px; right:-3px; width:8px; height:8px;
                    border-bottom:2px solid {c["ACCENT"]}60; border-right:2px solid {c["ACCENT"]}60;
                    background:{logo_bg};'></div>

                <!-- sys tag -->
                <div style='font-family:Share Tech Mono,monospace; font-size:0.5rem;
                    color:{c["ACCENT"]}80; letter-spacing:3px; margin-bottom:8px;'>[ SYS:ACTIVE ]</div>
                ...
                <div style='font-family:Share Tech Mono,monospace; font-size:0.48rem;
                    color:{c["TEXT3"]}; letter-spacing:4px;'>v2.0 // PERF TRACK</div>
            </div>
        </div>
        """, unsafe_allow_html=True)
        ...
        # Nav - Option A: Geometric SVG icons
        NAV_ITEMS = [
            ("Dashboard",
             '<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><polygon points="9,2 16,6 16,12 9,16 2,12 2,6" stroke="ICONCOLOR" stroke-width="1.5" fill="ICONFILL"/><circle cx="9" cy="9" r="2" fill="ICONCOLOR"/></svg>'),
            ("GPS Tracker",
             '<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><circle cx="9" cy="9" r="5.5" stroke="ICONCOLOR" stroke-width="1.5"/><circle cx="9" cy="9" r="2" fill="ICONCOLOR"/><line x1="9" y1="1" x2="9" y2="3.5" stroke="ICONCOLOR" stroke-width="1.5"/><line x1="9" y1="14.5" x2="9" y2="17" stroke="ICONCOLOR" stroke-width="1.5"/><line x1="1" y1="9" x2="3.5" y2="9" stroke="ICONCOLOR" stroke-width="1.5"/><line x1="14.5" y1="9" x2="17" y2="9" stroke="ICONCOLOR" stroke-width="1.5"/></svg>'),
            ("Manual Log",
             '<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><rect x="3" y="2" width="12" height="14" rx="1" stroke="ICONCOLOR" stroke-width="1.5"/><line x1="6" y1="6" x2="12" y2="6" stroke="ICONCOLOR" stroke-width="1.5"/><line x1="6" y1="9" x2="12" y2="9" stroke="ICONCOLOR" stroke-width="1.5"/><line x1="6" y1="12" x2="10" y2="12" stroke="ICONCOLOR" stroke-width="1.5"/></svg>'),
            ("History",
             '<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><rect x="2" y="2" width="14" height="5" rx="1" stroke="ICONCOLOR" stroke-width="1.5"/><rect x="2" y="11" width="14" height="5" rx="1" stroke="ICONCOLOR" stroke-width="1.5"/><line x1="5" y1="4.5" x2="7" y2="4.5" stroke="ICONCOLOR" stroke-width="1.5"/><line x1="5" y1="13.5" x2="7" y2="13.5" stroke="ICONCOLOR" stroke-width="1.5"/></svg>'),
            ("Quests",
             '<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><polygon points="9,1 11,6.5 17,6.5 12.5,10 14,16 9,12.5 4,16 5.5,10 1,6.5 7,6.5" stroke="ICONCOLOR" stroke-width="1.5" fill="ICONFILL"/></svg>'),
            ("Stats",
             '<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><polyline points="2,15 6,9 9,12 13,5 16,8" stroke="ICONCOLOR" stroke-width="1.5" stroke-linejoin="round" stroke-linecap="round" fill="none"/><circle cx="6" cy="9" r="1.5" fill="ICONCOLOR"/><circle cx="9" cy="12" r="1.5" fill="ICONCOLOR"/><circle cx="13" cy="5" r="1.5" fill="ICONCOLOR"/></svg>'),
            ("Settings",
             '<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><circle cx="9" cy="9" r="2.5" stroke="ICONCOLOR" stroke-width="1.5"/><path d="M9 1.5v2M9 14.5v2M1.5 9h2M14.5 9h2M3.7 3.7l1.4 1.4M12.9 12.9l1.4 1.4M3.7 14.3l1.4-1.4M12.9 5.1l1.4-1.4" stroke="ICONCOLOR" stroke-width="1.5" stroke-linecap="round"/></svg>'),
        ]

        nav_html = f"""
        <div style='padding:8px 0 2px; border-bottom:1px solid {c["BORDER2"]}40; margin-bottom:2px;'>
        ...
        """
        for name, svg_tpl in NAV_ITEMS:
            is_active = page == name
            if is_active:
                icon_color = c["ACCENT"]
                icon_fill = c["ACCENT"] + "30"
                text_color = c["ACCENT"]
                bar_color = c["ACCENT"]
                row_bg = f"rgba(255,179,0,0.08)" if c["dark_mode"] else "rgba(192,120,0,0.08)"
                fw = "700"
            else:
                icon_color = c["TEXT3"]
                icon_fill = "none"
            ...
            svg = svg_tpl.replace("ICONCOLOR", icon_color).replace("ICONFILL", icon_fill)
            ...
            <div style='display:flex; align-items:center; gap:12px;
                ...
                onclick="(function(){{
                    ...
                    for(var i=0;i<btns.length;i++){{
                        if(btns[i].innerText.trim()==='{name}'){{btns[i].click();break;}}
                    }}
                }})()">
                <span style='flex-shrink:0; display:flex; align-items:center;'>{svg}</span>
                <span style='font-family:Exo 2,sans-serif; font-size:0.92rem;
                    font-weight:{fw}; color:{text_color}; letter-spacing:0.5px;'>{name}</span>
            </div>
            """
        nav_html += "</div>"
        st.markdown(nav_html, unsafe_allow_html=True)

        # Hidden buttons for actual Streamlit navigation
        ...
        # Account + signout
        st.markdown(f"""
        <div style='padding:12px 16px 6px; border-top:1px solid {c["BORDER2"]}50; margin-top:4px;'>
            ...
            <div style='display:flex; align-items:center; gap:10px; margin-bottom:10px;'>
                <div style='width:32px; height:32px; border-radius:50%;
                    background:{"rgba(255,179,0,0.15)" if c["dark_mode"] else "rgba(192,120,0,0.15)"};
                    border:1.5px solid {c["BORDER2"]};
                    display:flex; align-items:center; justify-content:center;
                    font-size:1rem; flex-shrink:0;'>👤</div>
                <div style='font-family:Exo 2,sans-serif; font-size:0.78rem; font-weight:600;
                    color:{c["TEXT2"]}; word-break:break-all; line-height:1.3;'>
                    {st.session_state.user.email}
                </div>
            </div>
        </div>
        """, unsafe_allow_html=True)
        # Sign out - matching nav style
        signout_svg = f'<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M6 2H3a1 1 0 00-1 1v10a1 1 0 001 1h3" stroke="{c["TEXT3"]}" stroke-width="1.5" stroke-linecap="round"/><polyline points="10,5 13,8 10,11" stroke="{c["TEXT3"]}" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><line x1="13" y1="8" x2="6" y2="8" stroke="{c["TEXT3"]}" stroke-width="1.5" stroke-linecap="round"/></svg>'
        st.markdown(f"""
        <div style='border-top:1px solid {c["BORDER2"]}40; margin-top:4px;'>
          <div id='signout-row' style='display:flex; align-items:center; gap:12px;
              padding:10px 16px 10px 20px; cursor:pointer;
              border-left:3px solid transparent; transition:all 0.15s;'
              onmouseover="this.style.borderLeftColor='{c['DANGER']}';this.style.background='rgba(255,85,85,0.06)';this.querySelector('span').style.color='{c['DANGER']}'"
              onmouseout="this.style.borderLeftColor='transparent';this.style.background='transparent';this.querySelector('span').style.color='{c['TEXT3']}'"
              onclick="(function(){{var btns=window.parent.document.querySelectorAll('button');for(var i=0;i<btns.length;i++){{if(btns[i].innerText.trim()==='__SIGNOUT__'){{btns[i].click();break;}}}}}})()">
              {signout_svg}
              <span style='font-family:Exo 2,sans-serif; font-size:0.9rem; font-weight:500; color:{c["TEXT3"]}; letter-spacing:0.5px;'>Sign Out</span>
          </div>
        </div>
        """, unsafe_allow_html=True)

        st.markdown("<div style='display:none;'>", unsafe_allow_html=True)
        if st.button("__SIGNOUT__", key="signout"):
            sb.auth.sign_out()
        ...
        try:
            ...
            if dist_km > 0.001 and dur > 0:
                ...
                if route and len(route) >= 2:
                    ...
                    render_route_map(route, c, height=300)
        except Exception as e:
