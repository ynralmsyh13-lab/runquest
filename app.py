    ...
    with st.sidebar:
        ...
        <div style='padding:16px 12px 14px; background:{logo_bg}; border-bottom:2px solid {c["ACCENT"]}; position:relative; overflow:hidden;'>
            ...
            <div style='border:1px solid {c["ACCENT"]}40; padding:10px 10px; position:relative; border-radius:2px;'>
                ...
                <div style='font-family:Orbitron,sans-serif; font-weight:900; letter-spacing:2px; line-height:1; margin-bottom:6px;
                    font-size:clamp(1.2rem, 4vw, 1.7rem); white-space:nowrap;'>
...
def page_dashboard(user_id, profile, runs, unit, c):
    ...
    <div class='cyber-card'>
      <div style='display:flex; align-items:center; gap:14px; flex-wrap:wrap;'>
        <div style='font-size:2.8rem; line-height:1;'>{rank["icon"]}</div>
