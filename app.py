...
def render_sidebar(profile, page, c):
    with st.sidebar:
        ...
        # Nav - pure Streamlit buttons with SVG icons via CSS label trick
        NAV_ITEMS = [
            ("Dashboard",   "M9,2 16,6 16,12 9,16 2,12 2,6",  "polygon"),
            ("GPS Tracker", "crosshair",                        "crosshair"),
            ("Manual Log",  "doc",                              "doc"),
            ("History",     "rows",                             "rows"),
            ("Quests",      "star",                             "star"),
            ("Stats",       "chart",                            "chart"),
        ...
        SVG_ICONS = {
            "polygon": '<svg width="16" height="16" viewBox="0 0 18 18" fill="none" style="display:inline-block;vertical-align:middle;margin-right:10px;flex-shrink:0"><polygon points="9,2 16,6 16,12 9,16 2,12 2,6" stroke="ICONCOLOR" stroke-width="1.5" fill="ICONFILL"/><circle cx="9" cy="9" r="2" fill="ICONCOLOR"/></svg>',
            "crosshair": '<svg width="16" height="16" viewBox="0 0 18 18" fill="none" style="display:inline-block;vertical-align:middle;margin-right:10px;flex-shrink:0"><circle cx="9" cy="9" r="5.5" stroke="ICONCOLOR" stroke-width="1.5"/><circle cx="9" cy="9" r="2" fill="ICONCOLOR"/><line x1="9" y1="1" x2="9" y2="3.5" stroke="ICONCOLOR" stroke-width="1.5"/><line x1="9" y1="14.5" x2="9" y2="17" stroke="ICONCOLOR" stroke-width="1.5"/><line x1="1" y1="9" x2="3.5" y2="9" stroke="ICONCOLOR" stroke-width="1.5"/><line x1="14.5" y1="9" x2="17" y2="9" stroke="ICONCOLOR" stroke-width="1.5"/></svg>',
            "doc": '<svg width="16" height="16" viewBox="0 0 18 18" fill="none" style="display:inline-block;vertical-align:middle;margin-right:10px;flex-shrink:0"><rect x="3" y="2" width="12" height="14" rx="1" stroke="ICONCOLOR" stroke-width="1.5"/><line x1="6" y1="6" x2="12" y2="6" stroke="ICONCOLOR" stroke-width="1.5"/><line x1="6" y1="9" x2="12" y2="9" stroke="ICONCOLOR" stroke-width="1.5"/><line x1="6" y1="12" x2="10" y2="12" stroke="ICONCOLOR" stroke-width="1.5"/></svg>',
            "rows": '<svg width="16" height="16" viewBox="0 0 18 18" fill="none" style="display:inline-block;vertical-align:middle;margin-right:10px;flex-shrink:0"><rect x="2" y="2" width="14" height="5" rx="1" stroke="ICONCOLOR" stroke-width="1.5"/><rect x="2" y="11" width="14" height="5" rx="1" stroke="ICONCOLOR" stroke-width="1.5"/></svg>',
            "star": '<svg width="16" height="16" viewBox="0 0 18 18" fill="none" style="display:inline-block;vertical-align:middle;margin-right:10px;flex-shrink:0"><polygon points="9,1 11,6.5 17,6.5 12.5,10 14,16 9,12.5 4,16 5.5,10 1,6.5 7,6.5" stroke="ICONCOLOR" stroke-width="1.5" fill="ICONFILL"/></svg>',
            "chart": '<svg width="16" height="16" viewBox="0 0 18 18" fill="none" style="display:inline-block;vertical-align:middle;margin-right:10px;flex-shrink:0"><polyline points="2,15 6,9 9,12 13,5 16,8" stroke="ICONCOLOR" stroke-width="1.5" stroke-linejoin="round" stroke-linecap="round"/><circle cx="6" cy="9" r="1.5" fill="ICONCOLOR"/><circle cx="9" cy="12" r="1.5" fill="ICONCOLOR"/><circle cx="13" cy="5" r="1.5" fill="ICONCOLOR"/></svg>',
            "gear": '<svg width="16" height="16" viewBox="0 0 18 18" fill="none" style="display:inline-block;vertical-align:middle;margin-right:10px;flex-shrink:0"><circle cx="9" cy="9" r="2.5" stroke="ICONCOLOR" stroke-width="1.5"/><path d="M9 1.5v2M9 14.5v2M1.5 9h2M14.5 9h2M3.7 3.7l1.4 1.4M12.9 12.9l1.4 1.4M3.7 14.3l1.4-1.4M12.9 5.1l1.4-1.4" stroke="ICONCOLOR" stroke-width="1.5" stroke-linecap="round"/></svg>',
        }

        st.markdown(f"""
        <div style='padding:6px 0 4px; border-bottom:1px solid {c["BORDER2"]}40; margin-bottom:2px;'>
        ...
        for name, _, icon_key in NAV_ITEMS:
            is_active = page == name
            ac = c["ACCENT"]
            t3 = c["TEXT3"]
            t2 = c["TEXT2"]
            ...
            icon_color = ac if is_active else t3
            icon_fill = ac + "30" if is_active else "none"
            svg = SVG_ICONS[icon_key].replace("ICONCOLOR", icon_color).replace("ICONFILL", icon_fill)
            ...
            text_color = ac if is_active else t2
            fw = "700" if is_active else "500"

            st.markdown(f"""
            <div style='border-left:3px solid {bar_color}; background:{row_bg};
                display:flex; align-items:center; gap:0; padding:0;'>
                <div style='padding:10px 0 10px 14px; display:flex; align-items:center; pointer-events:none;'>
                    {svg}
                </div>
            </div>
            """, unsafe_allow_html=True)
